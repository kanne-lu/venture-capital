...
export default function AdminModule({ moduleKey, moduleLabel, adminName, rows: initialRows }: { moduleKey: AdminModuleKey; moduleLabel: string; adminName: string; rows: Record<string, unknown>[] }) {
